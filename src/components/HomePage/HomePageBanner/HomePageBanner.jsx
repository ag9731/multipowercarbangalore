    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 py-12 md:py-24 lg:py-32 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-10 mt-0 md:mt-5">
            <div className="flex-1 flex flex-col items-start justify-center gap-6 lg:gap-10 text-white">
              ...
              <p className="text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl">
                At Multi Power Car Service Bengaluru, we provide a complete
                range of garage services for vehicle owners in the area. Our
                skilled professionals are equipped to handle all types of car
                services with expertise. Offering top-quality repairs at
                unbeatable prices, we ensure the best service with
                state-of-the-art equipment and well-equipped workshops.
              </p>
